...
stdenv.mkDerivation rec {
  ...
  src = fetchgit {
    ...
    rev = "ef55192ef8a0d9bd336731350f73b709ffd101a0";
    sha256 = "sha256-zwy7Duk2RY4rd0SOayK8uV6ZxWYYbCNuJy50dqnKBeE=";
  };
  ...
  nativeBuildInputs = [ pkg-config makeWrapper gettext autoreconfHook ];
  buildInputs = [ zlib bzip2 git help2man autoconf-archive graphviz texinfo locale perlPackages.Po4a ] ++ modules;
