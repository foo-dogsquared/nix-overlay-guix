...
{ mkShell, lib, guile3-lib, guile-avahi, guile-gcrypt, guile-git, guile-gnutls
, guile-json, guile-lzlib, guile-semver, guile-sqlite3, guile-ssh, guile-zlib
, guile-zstd, git, guile_3_0, autoconf, automake, autoconf-archive, gcc
, coreutils, pkg-config, gettext, sqlite, perlPackages, help2man }:
...
in mkShell {
  ...
  GUILE_LOAD_PATH = let
    guilePath = lib.concatMap (module: [
